	...
	return BaseController.extend("sap-app.controllers.Worklist.List", {
		...
		onInit : function () {
			var oViewModel,
				...
				this.getOwnerComponent().setModel(oProductsModel,"productList")
		...
		onPress : function (oEvent) {
			...
			var supplierPath = oEvent.getSource()
            .getBindingContext("products")
            .getPath(),
          objectId = supplierPath.split("/").slice(-1).pop();
		...
		_applySearch: function(aTableSearchState) {
			var oTable = this.byId("table"),
				...
				console.log(oTable,"Table")
				console.log(oTable.getBinding("items"),"oTable.getBinding") 	
